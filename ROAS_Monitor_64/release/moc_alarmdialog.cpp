...
const QMetaObject AlarmDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AlarmDialog.data,
      qt_meta_data_AlarmDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AlarmDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AlarmDialog.stringdata0))
        return static_cast<void*>(const_cast< AlarmDialog*>(this));
