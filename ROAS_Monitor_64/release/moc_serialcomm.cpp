...
QT_MOC_LITERAL(1, 11, 18), // "sigReadyReadSerial"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 6), // "uchar*"
QT_MOC_LITERAL(4, 38, 6), // "packet"
QT_MOC_LITERAL(5, 45, 9), // "packetLen"
QT_MOC_LITERAL(6, 55, 12) // "sigBadPacket"

    },
    "SerialComm\0sigReadyReadSerial\0\0uchar*\0"
    "packet\0packetLen\0sigBadPacket"
};
...
void SerialComm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigReadyReadSerial((*reinterpret_cast< uchar*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->sigBadPacket(); break;
        default: ;
        }
        ...
        {
            typedef void (SerialComm::*_t)(uchar * , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialComm::sigReadyReadSerial)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SerialComm::sigBadPacket)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject SerialComm::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SerialComm.data,
      qt_meta_data_SerialComm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void SerialComm::sigReadyReadSerial(uchar * _t1, int _t2)
{
